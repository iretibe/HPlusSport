    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Categories>().HasData(
                new Categories { Id = 1, Name = "Active Wear - Men" },
                new Categories { Id = 2, Name = "Active Wear - Women" },
                new Categories { Id = 3, Name = "Mineral Water" },
                new Categories { Id = 4, Name = "Publications" },
                new Categories { Id = 5, Name = "Supplements" });
            ...
            modelBuilder.Entity<Users>().HasData(
                new Users { Id = 1, Email = "adam@example.com" },
                new Users { Id = 2, Email = "barbara@example.com" });
        }
    }
}
